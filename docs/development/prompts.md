...
```text
Trabaja sobre el monorepo Collab Modeler existente. Antes de modificar archivos, revisa docs/product/roadmap.md, README.md, docs/architecture.md y el código relacionado con el objetivo. Conserva las funcionalidades existentes y no reemplaces implementaciones reales por mocks o placeholders.
...
Criterio de aceptación: cualquier modelo descrito en docs/product/roadmap.md puede representarse sin perder información al guardarlo y volverlo a cargar.
```
