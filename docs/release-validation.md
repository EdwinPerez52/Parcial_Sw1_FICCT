...
| 7 | Ejecuta texto y voz; analiza PNG/JPEG/WebP y cancela una previsualización. Confirma otra propuesta. Prueba `AI_PROVIDER=openai` y `AI_PROVIDER=gemini`; sin la clave seleccionada, los comandos locales siguen funcionando y los complejos responden 503. | propuesta, proveedor, advertencias y revisión final |
