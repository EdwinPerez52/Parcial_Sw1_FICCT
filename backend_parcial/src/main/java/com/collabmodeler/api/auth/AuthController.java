...
public class AuthController {
    ...
    public record RegisterRequest(@NotBlank String fullName, @Email @NotBlank String email, @NotBlank String password,
                                  @NotBlank String passwordConfirmation, String invitationToken) {}
    ...
    public AuthController(AuthService auth, AuthRateLimiter limits) {
        this.auth = auth; this.limits = limits;
    }
    ...
    Map<String, String> register(@Valid @RequestBody RegisterRequest request, HttpServletRequest servletRequest) {
        ...
        String message = (request.invitationToken() != null && !request.invitationToken().isBlank())
            ? "Revisa tu correo para verificar la cuenta."
            : "Cuenta creada y guardada exitosamente. Ya puedes iniciar sesión.";
