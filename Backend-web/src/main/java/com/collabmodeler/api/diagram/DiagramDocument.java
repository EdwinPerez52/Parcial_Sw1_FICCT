...
public record DiagramDocument(
    ...
    public record Association(
        ...
        String owningSide, String relationType, String sourceHandle, String targetHandle, long version
    ) {
        public Association {
            owningSide = owningSide == null || owningSide.isBlank() ? "SOURCE" : owningSide;
            relationType = relationType == null || relationType.isBlank() ? "ASSOCIATION" : relationType;
            if (version < 1) version = 1;
        }

        public Association(UUID id, UUID sourceId, UUID targetId, String sourceCardinality,
                           String targetCardinality, String name, String sourceRole, String targetRole,
                           String owningSide, String relationType, long version) {
            this(id, sourceId, targetId, sourceCardinality, targetCardinality, name,
                sourceRole, targetRole, owningSide, relationType, null, null, version);
        }
        ...
        public Association(UUID id, UUID sourceId, UUID targetId, String sourceCardinality,
            ...
            this(id, sourceId, targetId, sourceCardinality, targetCardinality, name,
                sourceRole, targetRole, owningSide, "ASSOCIATION", null, null, version);
        }

        public Association(UUID id, UUID sourceId, UUID targetId, String sourceCardinality,
                           String targetCardinality, String name, long version) {
            this(id, sourceId, targetId, sourceCardinality, targetCardinality, name, null, null,
                "SOURCE", "ASSOCIATION", null, null, version);
        }
    }
