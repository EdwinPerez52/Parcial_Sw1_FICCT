...
import 'package:ventas/presentation/state/pedido_provider.dart';
import 'package:ventas/presentation/screens/pedido/pedido_form_screen.dart';
import 'package:ventas/presentation/screens/pedido/pedido_detail_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () async {
          final created = await Navigator.of(context).push<Pedido>(
                          ...
                          child: ListTile(
                            ...
                            onTap: () async {
                              await Navigator.of(context).push(
                                MaterialPageRoute(builder: (_) => PedidoDetailScreen(item: item)),
                              );
                              _provider.loadItems();
                            },
                          ),
