...
class ProductoDetailScreen extends StatefulWidget {
  final Producto item;
  const ProductoDetailScreen({super.key, required this.item});
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildRow('codigo', item.codigo),
                  _buildRow('precio', item.precio.toString()),
                  _buildRow('stock', item.stock.toString()),
