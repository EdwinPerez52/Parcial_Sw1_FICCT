...
import 'package:ventas/presentation/state/producto_provider.dart';
import 'package:ventas/presentation/screens/producto/producto_form_screen.dart';
import 'package:ventas/presentation/screens/producto/producto_detail_screen.dart';
...
class _ProductoListScreenState extends State<ProductoListScreen> {
  final ProductoProvider _provider = ProductoProvider();
                          ...
                          child: ListTile(
                                ...
                                IconButton(
                                  ...
                                  onPressed: () async {
                                    final updated = await Navigator.of(context).push<Producto>(
                                      MaterialPageRoute(builder: (_) => ProductoFormScreen(item: item)),
                                    );
                                    if (updated != null) {
                                      _provider.loadItems();
                                    }
                            ...
                            onTap: () async {
                              await Navigator.of(context).push(
                                MaterialPageRoute(builder: (_) => ProductoDetailScreen(item: item)),
                              );
                              _provider.loadItems();
                            },
                          ),
